                    ...
                    <div className='border-t flex p-3'>
                        ...
                        `}>
                            <div className='leading-4'>
                                ...
                                <span className='text-sx text-gray-600'>abhinav@abhinav.com</span>
                            </div>
...
export const SidebarItem = ({ icon, text, active, alert }) => {
    ...
    return (
        ...
        `}>
            ...
            {alert && <div className={`absolute ${expanded ? "right-2" : "right-0 top-0"} w-2 h-2 rounded bg-indigo-400`} />}
        </li>
    )
}
